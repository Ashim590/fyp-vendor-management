...
const PurchaseRequestDetails = () => {
  ...
  const { currentPurchaseRequest: purchaseRequest, loading, error } = useSelector(
          ...
          <div className="flex justify-between items-start">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-2xl font-bold">{purchaseRequest.title}</h1>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {purchaseRequest.requester?.fullname || "N/A"}
                    </p>
                  </div>
                  <div>
              ...
              <CardContent>
                {!purchaseRequest.linkedTender ? (
                  <p className="text-gray-500 text-center py-6">
                    No linked tender yet. Bids will appear after a tender is created from this request.
                  </p>
                ) : loadingBids ? (
                  <p className="text-gray-500 text-center py-6">Loading bids...</p>
                  ...
                  <div className="space-y-4">
                    {relatedBids.map((bid) => (
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div>
                            <h4 className="font-medium">{bid.vendor?.name || "Vendor"}</h4>
                        ...
                        <div className="mt-4 flex gap-2">
                          <Link to={`/tenders/${purchaseRequest.linkedTender}`}>
