...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "border-b border-slate-200/80 bg-slate-50/95 [&_tr]:border-b-0",
      className,
    )}
    {...props}
  />
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-slate-100/90 transition-colors hover:bg-slate-50/90 data-[state=selected]:bg-slate-100",
      className
    )}
    {...props} />
))
