        ...
        <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(11,31,77,0.12)] overflow-hidden grid md:grid-cols-[minmax(0,1.15fr),minmax(0,1fr)]">
          <div className="px-6 sm:px-10 py-8 sm:py-10 space-y-6">
            ...
            <form onSubmit={submitHandler} className="space-y-4 text-sm">
              ...
              <div>
                <Label className="text-xs">{req("Address")}</Label>
                <Input
                  type="text"
                  value={input.address}
                  name="address"
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <Label className="text-xs">{req("Province")}</Label>
                  <Input
                    type="text"
                ...
                <div>
                  <Label className="text-xs">{req("District")}</Label>
                  <Input
                    type="text"
              ...
              <div>
                <Label className="text-xs">{req("Business category")}</Label>
                <select
                  name="category"
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <Label className="text-xs">{req("PAN number")}</Label>
                  <Input
                    type="text"
                ...
                <div>
                  <Label className="text-xs">{req("Registration number")}</Label>
                  <Input
                    type="text"
              ...
              <fieldset className="rounded-lg border border-slate-200/90 bg-slate-50/50 p-4">
